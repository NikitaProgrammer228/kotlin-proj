...
public final class MeasurementController {
    ...
    public MeasurementController(double correctionFactor, double coordinationScale, double amplitudeThresholdMm, double calibrationDurationSec) {
        super();
    }
