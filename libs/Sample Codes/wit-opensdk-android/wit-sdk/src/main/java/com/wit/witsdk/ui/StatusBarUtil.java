...
import com.wit.witsdk.utils.OSUtil;
...
//        }
     ...
     * @return
     */
    public static void setStatusBarMode(Activity activity, boolean isTextDark,@ColorInt int color) {

        // 申请访问系统数据权限
        OSUtil.requestPermission(activity);
